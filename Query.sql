...
-- выбор тех пациентов, у которых гемоглобин попал в норму, а так же что за лаборатория cделала анализ
...
-- выбор тех пациентов, у которых гемоглобин не попал в норму, а так же что за лаборатория cделала анализ и ее документы
